...
export interface AgentChatMessage {
  ...
  id?: number;
  role: AnonymousSchema_72;
  sender?: string;
  text: string;
  timestamp: number;
}

export type AnonymousSchema_72 = 'user' | 'agent' | 'debug';
...
export interface SetOpenRouterApiKey {
  type: 'setOpenRouterApiKey';
  apiKey: string;
}

export interface ClearOpenRouterApiKey {
  type: 'clearOpenRouterApiKey';
}

export interface SubmitAgentPrompt {
  type: 'submitAgentPrompt';
  prompt: string;
}
