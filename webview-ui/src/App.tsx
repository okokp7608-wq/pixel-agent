...
import { AgentConversationPanel } from './components/AgentConversationPanel.js';
import { BottomToolbar } from './components/BottomToolbar.js';
import { ChangelogModal } from './components/ChangelogModal.js';
import { DebugView } from './components/DebugView.js';
import { EditActionBar } from './components/EditActionBar.js';
import { MigrationNotice } from './components/MigrationNotice.js';
import { OpenRouterKeyModal } from './components/OpenRouterKeyModal.js';
...
function App() {
  ...
  const [isOpenRouterKeyOpen, setIsOpenRouterKeyOpen] = useState(false);
  const [openRouterGatePassed, setOpenRouterGatePassed] = useState(false);
  const [openRouterPromptDismissed, setOpenRouterPromptDismissed] = useState(false);
  ...
  useEffect(() => {
    if (layoutReady && !openRouterGatePassed && !openRouterPromptDismissed) {
      setIsOpenRouterKeyOpen(true);
    }
  }, [layoutReady, openRouterGatePassed, openRouterPromptDismissed]);
  ...
  return (
    <div ref={containerRef} className="w-full h-full relative overflow-hidden">
      ...
      {!isDebugMode ? (
        <>
          ...
          <AgentConversationPanel
            ...
            apiReady={openRouterGatePassed && openRouterApiKeyConfigured}
            onOpenRouterKeySettings={() => {
              setOpenRouterPromptDismissed(false);
              setIsOpenRouterKeyOpen(true);
            }}
          />
        </>
      ...
      <SettingsModal
        ...
        onOpenRouterKeySettings={() => setIsOpenRouterKeyOpen(true)}
      />

      <OpenRouterKeyModal
        isOpen={isOpenRouterKeyOpen}
        onSaved={() => {
          setOpenRouterGatePassed(true);
          setOpenRouterPromptDismissed(true);
        }}
        onClose={() => {
          setOpenRouterPromptDismissed(true);
          setIsOpenRouterKeyOpen(false);
        }}
      />
